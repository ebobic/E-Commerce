...
export default function ContactForm() {
  ...
  return (
    <section id="contact" className="grid grid-cols-1 pb-10 w-full justify-self-center">
      <div className="w-full pt-6 pb-2 text-center justify-self-center">
        <h2 className="pt-6 text-2xl font-bold">Get In Touch With Us</h2>
        <p className="m-auto p-2 text-sm w-full sm:w-full">
      ...
      <Form action={handleSubmit} className="grid place-content-center">
        ...
        />
        <textarea
          className="mt-2 py-1 px-2 rounded-lg bg-blue-100 w-full m-auto sm:w-full"
          rows={5}
          cols={40}
          name="message"
        ...
        <div className="sm:grid sm:justify-self-start">
          <button
            type="submit"
            className="grid justify-self-center mt-4 py-0.5 px-4 rounded-full text-white bg-blue-900 hover:bg-blue-800 m-auto"
          >
            Send Message
          </button>
        </div>

    ...
    return(
        <section id="about" className="bg-slate-100 py-12">
            <div className="flex flex-col m-auto text-center w-9/10 md:w-7/10 lg:w-6/10 xl:w-5/10">
                <h2 className="font-bold text-2xl text-neutral-800 ">Get To Know Who We Are And What We Do</h2>
            ...
            {showLink && (
                <div className="flex justify-center ">
                    <Link href="/about" className="bg-blue-900 rounded-full text-white px-4 py-0.5 hover:bg-blue-800">Learn More</Link>  
                </div>
            )}
        </section>
    )
